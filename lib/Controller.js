...
class Controller extends EventEmitter {
  ...
  // Set beforeRespond hook, see `__setHook` action
  beforeRespond(nameOrFn, options) {
    return this.__setHook('beforeRespond', nameOrFn, options);
  }
  ...
  skipBeforeRespond(nameOrFn, options) {
    return this.__skipHook('beforeRespond', nameOrFn, options);
  }
