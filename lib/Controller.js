...
class Controller extends EventEmitter {
  ...
  constructor(name, mountPath) {
    ...
    // Controller base path, originally extended from parent Controller
    this.basePath = typeof super.getMountPath === 'function' ? super.getMountPath() : '/';
