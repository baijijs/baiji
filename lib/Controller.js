...
class Controller extends EventEmitter {
  ...
  constructor(name, mountPath) {
    ...
    //          { name: 'gender', type: 'number', enum: [0, 1] },
    //          { name: 'hobbies', type: ['object'], params: [{ name: 'name' }, { 'name': 'years' }] }
    //        ],
    //        route: { path: '/', verb: 'post' },
    //        method: 'createUserByDetails'
    //      }
    //    }
  ...
  __skipHook(type, name, skipOptions) {
    ...
    assert(typeof this[name] === 'function', `No method named '${name}' defined`);
