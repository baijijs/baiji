...
class ExpressContext extends Context {
  ...
  param(name) {
    ...
    let args = magico.get(req.params, 'args') ||
               ...
               magico.get(req.query, 'args') || undefined;
    ...
    let arg = magico.get(args, name) ||
              magico.get(req.params, name) ||
              magico.get(req.body, name) ||
              magico.get(req.query, name) ||
              req.get(name);
    ...
    if (ctx._done || ctx.response.headersSent || ctx.response.finished) {
