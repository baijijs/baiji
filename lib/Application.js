...
class Application extends EventEmitter {
  ...
  _useController(ctrl, options) {
    ...
    // Set description
    app.set('description', ctrl.description);
  ...
  fullName() {
    return this.parent && typeof this.parent.fullName === 'function' ? `${this.parent.fullName()}.${this.name}` : this.name;
  }

  fullPath() {
    let mountPath = this.mountPath || '/';
    return this.parent && typeof this.parent.fullPath === 'function' ? path.posix.join(this.parent.fullPath(), mountPath) : mountPath;
  }
}
