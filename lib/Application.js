...
class Application extends EventEmitter {
  ...
  clone() {
    ...
    // Merge settings
    app.settings = _.assign({}, this.settings);
    app.settings.adapterOptions = _.assign({}, this.get('adapterOptions') || {});

    // Merge hooks
    app.beforeHooks = _.assign({}, this.beforeHooks);
    app.afterHooks = _.assign({}, this.afterHooks);
    app.afterErrorHooks = _.assign({}, this.afterErrorHooks);

    // Merge locals
    app.locals = _.assign({}, this.locals);
  ...
  _useController(ctrl, options) {
    ...
    let app = new Application(name, _.assign({}, this.settings));
